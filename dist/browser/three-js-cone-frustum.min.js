...
const r = o.subVectors(e, t);
if (0 === r.length()) throw "Capsule height must not be zero";
const n = (a - s) / r.length(),
d = r.length() + n * (s - a),
c = new i().copy(t).addScaledVector(r.normalize(), n * s),
u = Math.cos(Math.asin(n));
return new h(c, r, d, s * u, a * u);
}
