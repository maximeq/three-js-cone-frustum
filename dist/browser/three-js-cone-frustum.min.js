...
n = new e(),
h = new e(),
c = new a(2, 2, 2).attributes.position;
class d {
...
n = o.length() + r * (s - a),
h = new i().copy(t).addScaledVector(o.normalize(), r * s),
c = Math.cos(Math.asin(r));
return new d(h, o, n, s * c, a * c);
}
...
const s = c.clone();
o.copy(this.base).addScaledVector(this.axis, this.height / 2);
const i = Math.max(this.radius0, this.radius1);
h.makeScale(i, this.height / 2, i),
n.multiply(h),
h.applyToBufferAttribute(s),
r.set(0, 1, 0);
const e = r.angleTo(this.axis);
return (
r.cross(this.axis),
h.makeRotationAxis(r, e),
h.applyToBufferAttribute(s),
o.sub(t),
n.makeTranslation(o.x, o.y, o.z),
n.applyToBufferAttribute(s),
s.array
);
}
equals(t) {
...
c = t.dot(t),
d = this.direction.dot(i.axis),
u = this.direction.dot(t),
l = this.direction.dot(this.direction),
p = i.radius0 * i.radius0 + 2 * n * h + r * h * h - c,
x = n * d + r * h * d - u,
f = r * d * d - l;
if (0 !== f) {
const o = x * x - f * p;
...
let c = i.axis.dot(e);
h >= 0 && c >= 0 && c <= i.height && (s.addVectors(i.base, e), r++);
const d = (-x + n) / f;
return (
e.copy(t),
e.addScaledVector(this.direction, d),
(c = i.axis.dot(e)),
d >= 0 &&
(0 === r || h > d) &&
c >= 0 &&
