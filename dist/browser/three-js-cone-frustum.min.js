...
const f = h.clone(),
x = Math.max(e, o);
n.makeScale(x, p / 2, x), n.applyToBufferAttribute(f), a.set(0, 1, 0);
const g = a.angleTo(d);
return (
a.cross(d).normalize(),
a.length() > 0 && (n.makeRotationAxis(a, g), n.applyToBufferAttribute(f)),
a
.copy(r)
