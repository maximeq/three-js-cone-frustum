...
const l = (a - e) / d.length(),
p = Math.cos(Math.asin(l)),
f = d.length() + l * (e - u * u * a),
g = d.length() + l * (e - a);
...
n.makeScale(b * y, f / 2, b * y), n.applyToBufferAttribute(x), o.set(0, 1, 0);
const V = o.angleTo(d),
S = o.dot(d);
return (
o.cross(d).normalize(),
o.length() > 0
? (n.makeRotationAxis(o, V), n.applyToBufferAttribute(x))
: S < 0 && (n.makeRotationZ(Math.PI), n.applyToBufferAttribute(x)),
o
.copy(r)
.addScaledVector(d, f / 2)
.sub(c),
n.makeTranslation(o.x, o.y, o.z),
n.applyToBufferAttribute(x),
x.array
);
}
equals(t) {
